          ...
          <div className='flex flex-col justify-center gap-12'>
            <div className='flex flex-col gap-4'>
              <h1 className="text-2xl font-bold">Arcane <br />  
                <span className="text-5xs text-red-500 md:text-6xl">Legend </span>Of <br />
                <span className=" text-5xs text-blue-500 relative mr-19 md:text-6xl left-27">Legend</span>
              </h1>
